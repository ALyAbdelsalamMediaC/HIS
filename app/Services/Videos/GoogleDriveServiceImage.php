...
class GoogleDriveServiceImage
{
    ...
    public function uploadFile($file, $name)
    {
        $fileMetadata = new DriveFile([
            'name' => $name,
            'parents' => [env('GOOGLE_DRIVE_FOLDER_ID')], //  Upload to specific folder
    ...
    public function uploadImage($file, $name)
    {
        $fileMetadata = new DriveFile([
            'name' => $name,
            'parents' => [env('GOOGLE_DRIVE_FOLDER_V_IMAGES')], //  Upload to specific folder
