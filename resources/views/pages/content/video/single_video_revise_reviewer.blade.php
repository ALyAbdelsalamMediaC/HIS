@extends('layouts.app')
@section('title', 'HIS | Video - Reviewer Review (Revise)')
@section('content')
  ...
  <div class="gap-3 mb-4 d-flex align-items-center">
    ...
    <div>
      <h2 class="h2-semibold" style="color:#35758C;">Video Reviewer Review (Revise)</h2>
      <p class="h5-ragular" style="color:#ADADAD;">This video has been sent back for revision. You can view your rating and comments below. All actions are locked.</p>
    </div>
  </div>
  ...
  <section class="single-video-container">
    ...
    <div class="d-flex justify-content-between align-items-center">
      <div class="gap-3 mt-2 d-flex align-items-center">
        ...
        <span class="h5-ragular" style="color:#ADADAD;">Uploaded {{ $media->created_at->diffForHumans() }}</span>
    ...
    <div class="mt-3 single-discription">
      <div class="h5-ragular description-content-wrapper quill-content" id="description-content-{{ $media->id }}">
        <div class="description-text" id="description-text-{{ $media->id }}" style="white-space: pre-wrap;">{!! $media->description !!}</div>
